    ...
    <%@include file="Header.jsp" %>
        ...
        <div>
            <table  border="1" style="border-collapse:collapse;border:1px solid gray;font-size: 30px;color: black;width: 220px">
                ...
                <tr>
                    <td><a href="kichenacc.jsp" style="text-decoration: none;color: black"><font style="color: #000000;font-family: myFFont;font-size: 20px">&nbsp;&nbsp;&nbsp;Kitchen Accounts&nbsp;&nbsp;&nbsp; </font></a></td>
                </tr>
                <tr>
        ...
        <form name="frm" id="fr" action="CreateWaiter" method="post" onsubmit="return validate()">
        <div style="margin-top: -270px;margin-left: 310px;font-size: 30px;font-family: myFirstFont">
                 ...
                 <tr>
                     <td><b style="font-size: 20px">Email Id <b></td>
                                 ...
                                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                     ...
                                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                     <b style="font-size: 20px"> Phone Number</b>&nbsp;&nbsp;<b>:&nbsp;&nbsp;</b><input type="text" name="phone"size="30px"> 
                                     </td> </tr>
      <div>
             ...
             <table>
                 <%
                     ...
                     while(itr.hasNext()){
                         ...
                         if(i%5==0)
                             out.println("<td style='width:200px'><input type='checkbox' name='tables' value='"+tf.getTableId()+"'/>"+tf.getTableName()+"</td></tr><tr>");
                         else
                             out.println("<td style='width:200px'><input type='checkbox' name='tables' value='"+tf.getTableId()+"'/>"+tf.getTableName()+"</td>");
                         i++;
                     }
                 %>
             </tr>
