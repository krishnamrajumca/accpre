...
<%
    ...
    while(itr.hasNext()){
        ...
        while(iit.hasNext()){
            ...
            if(itms.contains(iid))
            out.println("<tr data-tt-id='"+iid+"' data-tt-parent-id='"+mid+"'><td><input type='checkbox'  name='items' value='"+iid+"' checked>"+iname+"</td></tr>");
            else
