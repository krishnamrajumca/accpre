...
<%
    ...
    <%@include file="Header.jsp" %>
        ...
        <div style="margin-top: -240px;margin-left: 310px;font-size: 30px;font-family: myFirstFont">
           ...
           %>
           <b style="border-radius:10px; height:30px;background: #d0d0d0;font-size: 30px;text-decoration: none;color:black">&nbsp;&nbsp;&nbsp;<a href="kitchenacc.jsp"style="text-decoration: none"> < Back </a>&nbsp;&nbsp;&nbsp;</b>
            <b style="border-radius:10px; height:30px;background: #d0d0d0;font-size: 30px;text-decoration: none;color: black">&nbsp;&nbsp;&nbsp;<a href="delkichen.jsp?id=<%=id%>"style="text-decoration: none"> Delete</a>&nbsp;&nbsp;&nbsp;</b>
             <b style="border-radius:10px; height:30px;background: #d0d0d0;font-size: 30px;text-decoration: none;color: black">&nbsp;&nbsp;&nbsp;<a href="editkichen.jsp?id=<%=id%>"style="text-decoration: none"> Edit</a>&nbsp;&nbsp;&nbsp;</b>
        ...
        <div  style="margin-left: -10px;background-color: gray;font-size: 25px;color:white;font-family: myFirstFont">
                 ...
                 <tr>
                     <td><b style="font-size: 20px">Email Id  <b></td>
                                 ...
                                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                     ...
                                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                     <b style="font-size: 20px"> Phone Number </b>&nbsp;&nbsp;<b>:&nbsp;&nbsp;</b><%=k.getPhone()%>
                                     </td> </tr>
      <div>
        ...
        <br>
         ...
         <div  style="margin-left: -10px;font-family: myFFont">
             <%
                ArrayList<String> l=k.getItemsList();
                Iterator itr=l.iterator();
                while(itr.hasNext()){
                    String item=(String)itr.next();
                    out.println(Accounts.getItemName(item)+"<br/>");
                }
             %>
           </div>
        ...
        <div style="margin-left: 900px;font-family: myFirstFont">
            <b style="border-radius:10px; height:30px;background: #d0d0d0;font-size: 30px;text-decoration: none">&nbsp;&nbsp;&nbsp;<a href="kitchenacc.jsp"style="text-decoration: none"> < Back </a>&nbsp;&nbsp;&nbsp;</b>
            <b style="border-radius:10px; height:30px;background: #d0d0d0;font-size: 30px;text-decoration: none">&nbsp;&nbsp;&nbsp;<a href="delkichen.jsp?id=<%=id%>"style="text-decoration: none"> Delete</a>&nbsp;&nbsp;&nbsp;</b>
             <b style="border-radius:10px; height:30px;background: #d0d0d0;font-size: 30px;text-decoration: none">&nbsp;&nbsp;&nbsp;<a href="editkichen.jsp?id=<%=id%>"style="text-decoration: none"> Edit</a>&nbsp;&nbsp;&nbsp;</b>
        </div>
