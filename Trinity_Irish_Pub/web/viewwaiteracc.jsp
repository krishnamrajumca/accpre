    ...
    <head>
        ...
        <script type="text/javascript">
            function delet(){
                ...
                if(c)
                    window.location.href="delwaiter.jsp?id="+id;
            }
        </script>
...
<%
    ...
    <%@include file="Header.jsp" %>
        ...
        %>
           <b style="border-radius:10px; height:30px;background:#D0D0D0;font-size: 30px;text-decoration: none;color:black">&nbsp;&nbsp;&nbsp;<a href="waiteraccount.jsp "style="text-decoration: none"> < Back </a>&nbsp;&nbsp;&nbsp;</b>
           <b style="border-radius:10px; height:30px;background:#D0D0D0;font-size: 30px;text-decoration: none;color: black">&nbsp;&nbsp;&nbsp;<a href="javascript:delet('<%=id%>')"style="text-decoration: none"> Delete</a>&nbsp;&nbsp;&nbsp;</b>
             <b style="border-radius:10px; height:30px;background:#D0D0D0;font-size: 30px;text-decoration: none;color: black">&nbsp;&nbsp;&nbsp;<a href="editwaiter.jsp?id=<%=id%>"style="text-decoration: none"> Edit</a>&nbsp;&nbsp;&nbsp;</b>
             ...
             <table>
                 ...
                 <tr>
                     <td><b style="font-size: 20px">Email Id &nbsp;&nbsp;<b></td>
                                 <td>:&nbsp;&nbsp;  
                                   <%=email%>&nbsp;&nbsp;&nbsp;&nbsp;
                                     <b style="font-size: 20px"> Phone Number&nbsp;&nbsp;</b>:&nbsp;&nbsp;&nbsp;&nbsp;<%=ph%>
                                     </td> </tr>
      <div>
             ...
             <table>
                 <%
                    ...
                    while(itr.hasNext())
                    {
                        ...
                        out.println(Accounts.getTableName(i)+"<br/>");
                    }
                 %>
             </table>
           </div>
        ...
        <div style="margin-left: 900px">
            <b style="border-radius:10px; height:30px;background:#D0D0D0;font-size: 30px;text-decoration: none;color:black;font-family: myFirstFont">&nbsp;&nbsp;&nbsp;<a href="waiteraccount.jsp"style="text-decoration: none"> < Back </a>&nbsp;&nbsp;&nbsp;</b>
           <b style="border-radius:10px; height:30px;background:#D0D0D0;font-size: 30px;text-decoration: none;color: black;font-family: myFirstFont">&nbsp;&nbsp;&nbsp;<a href="javascript:delet('<%=id%>')"style="text-decoration: none"> Delete</a>&nbsp;&nbsp;&nbsp;</b>
             <b style="border-radius:10px; height:30px;background:#D0D0D0;font-size: 30px;text-decoration: none;color: black;font-family: myFirstFont">&nbsp;&nbsp;&nbsp;<a href="editwaiter.jsp?id=<%=id%>"style="text-decoration: none"> Edit</a>&nbsp;&nbsp;&nbsp;</b>
        </div>
