...
<%
    ...
    <td style="background: url(images/selected.png);width: 205px;height: 43px;text-align: center;font-size: 18px;text-align: center"><b>
                        <font face="Helvetica Rounded LT Std"style="color:black;font-size: 21px; font-family: myFFont;"><a href="KichenDisplay.jsp" Style="color:#ffffff">Kitchen Display</a>
                    </FONT></b></td>
                    ...
                    <td style="background: url(images/unselected.png);width: 205px;height: 43px;text-align: center;font-size: 18px;text-align: center"><b>
                            <font face="Helvetica Rounded LT Std"style="color:black;font-size: 21px; font-family: myFFont;"><a href="WaiterDisplay.jsp" Style="color:#000000">Waiter Display</a>
                    </FONT></b></td>
                    </table>
        <table>
    <tr>
...
<!--        <div style=color:lightslategray>
        ...
        <fieldset style="margin-left: 30px;background: white">
...
%>
                     ...
                     <%if(cnt!=count){
                         ...
                         out.println("<embed height='0' width='0' src='css/s.mp3'/>");
                     }
                     else{
                        System.out.println("cnt:"+cnt+" count:"+count);
                     }%>
        ...
        <td>                      <!--embed height="0" width="0" src="css/s.mp3"/>-->
            <div style="color:#fffff;margin-top: -55px;overflow-y: auto;height:550px" class="scrollbar">
                <font face="Helvetica Rounded LT Std" style="color:black;font-size: 22px; font-family:myFirstFont;"> &nbsp;&nbsp;&nbsp;Table&nbsp; <%=activeid%> </font>
             <table  class="TFtable" width="900" style="text-align: center;border:1px solid #D3D3D3;border-collapse: collapse;">

                
                <th style='border: 1px black' bgcolor="575857"style="border:1px solid #D3D3D3;"><font face="Helvetica Rounded LT Std"style="color:#ffffff;font-size: 16px; font-family: myFFont;">Item name </font></th>
                  
                   <th style='border: 1px black' bgcolor="575857"style="border:1px solid #D3D3D3;"><font face="Helvetica Rounded LT Std"style="color:#ffffff;font-size: 16px; font-family: myFFont;">Quantity</font></th>
                   <th style='border: 1px black' bgcolor="575857"style="border:1px solid #D3D3D3;"><font face="Helvetica Rounded LT Std"style="color:#ffffff;font-size: 16px; font-family: myFFont;">Status </font></th>
                   <th style='border: 1px black' bgcolor="575857"style="border:1px solid #D3D3D3;"><font face="Helvetica Rounded LT Std"style="color:#ffffff;font-size: 16px; font-family: myFFont;">Action </font></th>
...
String act=af.getKitchenAction();
%>
<tr>
                    <td style="border:1px solid #D3D3D3;width:50%"align="left" ><%=name%> </td>
                  
                   <td style="border:1px solid #D3D3D3;"><%=qt%></td>
                   <td style="border:1px solid #D3D3D3;"><%=st%> </td>
                   <td style="border:1px solid #D3D3D3;"><%=act%> </td>
                  </tr>
                  <%
}
%>
