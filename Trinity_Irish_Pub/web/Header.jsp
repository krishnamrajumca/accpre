...
<%}%>
   ...
   <%
        ...
        <tr style="width: 100%">
            ...
            <%}%>
<!--                  <td style="background: url(images/rep.png);width: 112px;height: 81px;text-align: center;font-size: 18px"><b><FONT COLOR=WHITE><a href="Reports.jsp" Style="color:white;font-size: 15px"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;    </a></FONT></b></td>
                  <td style="background: url(images/act.png);width: 112px;height: 81px;text-align: center;font-size: 18px"><b><FONT COLOR=WHITE><a href="Accounts.jsp" Style="color:white;font-size: 15px"> &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  </a></FONT></b></td>
                  -->
        </tr>   
        </table>
                                            </div>
                                        ...
                                        <table>
                                            <tr>   
            <!--<td style="margin-top: 20px"><input class="uim" type="button" value="" onClick="javascript:window.location='Contact.jsp';"> </td>-->
            ...
            <!--<input type="button" onClick="/LoginPage.jsp" value=""/style="background: url(images/grid.png)">--> 
            </tr>     
            <tr></tr><tr></tr><tr></tr>
            <tr></tr><tr></tr>
            <tr>
            ...
            <!--<td style="background: url(images/unselected.png);width: 112px;height: 81px;text-align: center;font-size: 18px"><b><FONT COLOR=WHITE><a href="LoginPage.jsp" Style="color:white;font-size: 15px">Logout</a></FONT></b></td>-->
        </tr>
                                        </table>
                                            </div>
</div>
